...
def generate_pdf_content(pdf, document, current_unit: str, start_y: float = 20) -> float:
    ...
    add_line(f"Glazing thick: {format_value(glazing_thick, current_unit)}", right_col)
    add_line(f"Matboard thick: {format_value(matboard_thick, current_unit)}", right_col)
    add_line(f"Artwork thick: {format_value(artwork_thick, current_unit)}", right_col)
    add_line(f"Backing thick: {format_value(backing_thick, current_unit)}", right_col)
